// quote_service/backend/src/main/java/com/example/QuoteService.java
...
public class QuoteService {
    ...
    public static void main(String[] args) {
        ...
        get("/quote", (req, res) -> {
            // Span span = tracer.spanBuilder("get_random_quote").startSpan();
        ...
        post("/quote", (req, res) -> {
            // Span span = tracer.spanBuilder("insert_quote").startSpan();
